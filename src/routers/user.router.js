...
const { getUser,  Register, Login, Logout, protectedUser, changeAvailabilty, changePassword, requestDonor, deleteRequest, updateProfile, getFilteredData, banuser, newaccess, removeaccess, deleteUser, forgetpassword, resetPassword } = require('../controllers/user.controller')
